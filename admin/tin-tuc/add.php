...
<head>
  ...
  <title>AdminLTE 2 | Tạo bài viết</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <form name="myForm" class="myForm" onsubmit="return validateForm()" action="<?= $adminUrl ?>tin-tuc/save-add.php" method="post" enctype="multipart/form-data">
        <div class="col-md-6">
            <!-- Tên bài viết -->
